...
while True :
        if plot==1:
                talk =["Chapter 0 : The start of everything",
                        "!!!",
                        "I forget it ! I must be at shipside at 3:00 already!",
                        "Hurry ! No time !"]
                ...
                print_on_screen("And where is Carlos?",WHITE,50)
                ...
                win.fill((0,0,0))
                pygame.display.update()
                talk = [['I steer the wheel of the boat, nothing happened.',GREEN,50],
                        ['As if time stopped, the boat\'s quiet weirdly.',GREEN,50],
                        ['............',WHITE,100],
                        ['When I\'m thinking what\'s this wheel doing,',GREEN,50],
                        ['The light was opened.',GREEN,50]]
                ...
                talk = [['If you ask me who is carlos,',WHITE,30],
                        ['Or if you ask me who am I ?',WHITE,30],
                        ['I can tell you now.',WHITE,30],
                        ['Carlos is my brother,',WHITE,30],
                        ['which is fifteen years old.',WHITE,30],
                        ['I am Sceny, I know it\'s a strange name.',WHITE,30],
                        ['One day I\'m finding my brother on the boat,',WHITE,30],
                        ['I drive the boat in accident,',WHITE,30],
                        ['The boat crushed into something.',WHITE,30],
                        ['I have no time to escape.',WHITE,30],
                        ['So, it just happended.',WHITE,30]]
                ...
                font_2 = pygame.font.SysFont('Comic Sans MS',10)
                textsurface_up = font.render('To    Be', False, RED)
                textsurface_down = font.render('Continued',False,RED)
                textsurface_version = font_2.render('V.WIP.0.2',False,GREEN)
